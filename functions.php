...
function load_my_style_script_header() {
    ...
    wp_register_script('jquery', 'http://ajax.googleapis.com/ajax/libs/jquery/2.2.4/jquery.min.js');
...
function load_my_style_script_footer() {
    /* JS */
    wp_enqueue_script('ajax-add' , get_template_directory_uri() . '/js/ajax-add.js', array('jquery'), null, true);
    wp_localize_script('ajax-add', 'ajax_add' , array(
        'url' => admin_url( 'admin-ajax.php' ),
        'nonce' => wp_create_nonce('add-nonce')
    ));
...
/* Внешний вид -> Опции темы */
require get_parent_theme_file_path( '/functions/settings.php' );

/* Переопределенные функции woocommerce */
require get_parent_theme_file_path( '/functions/woocommerce.php' );
...
function twentyseventeen_widgets_init() {
    register_sidebar( array(
        'name'          => __( 'Products Filter Shop', 'twentyseventeen' ),
        'id'            => 'sidebar-left',
        'description'   => __( 'Add widgets Products Filter.', 'twentyseventeen' ),
